...
public class TodoDevelopmentServiceSwaggerConfig {

    final ProfileConfigurationProperties profileConfigurationProperties;

    public TodoDevelopmentServiceSwaggerConfig(ProfileConfigurationProperties profileConfigurationProperties) {
