...
import eu.mithril.training.spring.boot.todo.model.response.Issue;
import eu.mithril.training.spring.boot.todo.model.response.TodoErrorResponse;
import eu.mithril.training.spring.boot.todo.model.response.TodoResponse;
import eu.mithril.training.spring.boot.todo.model.response.TodoSuccessResponse;
...
import eu.mithril.training.spring.boot.todo.model.response.TodoCollectionResponse;
