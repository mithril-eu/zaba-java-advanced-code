...
. Invalid ID +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/exception/InvalidIdException.java[InvalidIdException.java]

. Invalid Assignee +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/exception/InvalidAssigneeException.java[InvalidAssigneeException.java]

. Todo Not Found +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/exception/TodoNotFoundException.java[TodoNotFoundException.java]

. Constants +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/TodoConstants.java[TodoConstants.java]
