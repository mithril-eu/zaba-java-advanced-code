...
. Service Interface +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/service/TodoService.java[TodoService.java] +
.. This interface defines all the service methods that are publicly available.

. Service Implementation +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/service/TodoServiceImpl.java[TodoServiceImpl.java] +
...
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/service/TodoServiceTest.java[TodoServiceTest.java]
