...
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/response/Status.java[Status.java]

. A Metadata object to provide request and response metadata +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/response/Metadata.java[Metadata.java]

. An Issue object to include exception details issue code and description +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/response/Issue.java[Issue.java]

. A TodoResponse interface is a marker interface for several other responses +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/response/TodoResponse.java[TodoResponse.java]
...
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/response/TodoSuccessResponse.java[TodoSuccessResponse.java]

. A TodoErrorResponse object that includes a metadata and a list of issues associated +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/response/TodoErrorResponse.java[TodoErrorResponse.java]

. A TodoCollectionResponse object that includes a metadata and a list of todo objects +
⇒ link:../../todo/src/main/java/eu/mithril/training/spring/boot/todo/model/response/TodoCollectionResponse.java[TodoCollectionResponse.java]
...
. StatusTest +
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/model/response/StatusTest.java[StatusTest.java]

. MetadataTest +
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/model/response/MetadataTest.java[MetadataTest.java]

. IssueTest  +
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/model/response/IssueTest.java[IssueTest.java]

. TodoSuccessResponseTest +
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/model/response/TodoSuccessResponseTest.java[TodoSuccessResponseTest.java]

. TodoErrorResponseTest  +
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/model/response/TodoErrorResponseTest.java[TodoErrorResponseTest.java]

. TodoCollectionResponseTest +
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/model/response/TodoCollectionResponseTest.java[TodoCollectionResponseTest.java]
...
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/controller/TodoAPIContractTest.java[TodoAPIContractTest.java]
...
. Abstract mock setup +
⇒ link:../../todo/src/test/java/eu/mithril/training/spring/boot/todo/AbstractTodoMockSetupTest.java[AbstractTodoMockSetupTest.java]
