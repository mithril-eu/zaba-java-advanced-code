...
- Logging use +
⇒ link:../../ch05_spring-hibernate/src/main/java/eu/mithril/training/spring/framework/ch05/controller/ColoredShapeControllingBean.java[ColoredShapeControllingBean.java]
...
⇒ link:../../ch05_spring-hibernate/src/main/java/eu/mithril/training/spring/framework/ch05/config/HibernateSessionConfig.java[HibernateSessionConfig.java] +
...
. Component scan +
⇒ link:../../ch05_spring-hibernate/src/main/java/eu/mithril/training/spring/framework/ch05/config/ColoredShapeConfig.java[ColoredShapeConfig.java] +
...
⇒ link:../../ch05_spring-hibernate/src/main/java/eu/mithril/training/spring/framework/ch05/ColoredShapeApplication.java[ColoredShapeApplication.java] +
...
. *Service* layer +
⇒ link:../../ch05_spring-hibernate/src/main/java/eu/mithril/training/spring/framework/ch05/service/ColoredShapeServiceImpl.java[ColoredShapeServiceImpl.java] +
...
. *DAO* layer +
⇒ link:../../ch05_spring-hibernate/src/main/java/eu/mithril/training/spring/framework/ch05/dao/ColoredShapeDaoImpl.java[ColoredShapeDaoImpl.java] +
...
. *Model* layer +
⇒ link:../../ch05_spring-hibernate/src/main/java/eu/mithril/training/spring/framework/ch05/model/ColoredShape.java[ColoredShape.java] +
