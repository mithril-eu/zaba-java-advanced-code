...
⇒ link:../../ch04_spring-persistence/src/main/java/eu/mithril/training/spring/framework/ch04/model/ColoredShape.java[ColoredShape.java] +
Model for the Colored Shape

. Creating an interface to abstract the methods of the *Data Access Object*. Check the
Create-Read-Update-Delete (*CRUD*) operations. +
⇒ link:../../ch04_spring-persistence/src/main/java/eu/mithril/training/spring/framework/ch04/dao/ColoredShapeDao.java[ColoredShapeDao.java] +
...
⇒ link:../../ch04_spring-persistence/src/main/java/eu/mithril/training/spring/framework/ch04/Ex01_DB_XMLConfigured.java[Ex01_DB_XMLConfigured.java] +
...
⇒ link:../../ch04_spring-persistence/src/main/java/eu/mithril/training/spring/framework/ch04/dao/ColoredShapeDaoImplEx01.java[ColoredShapeDaoImplEx01.java] +
...
This example demonstrates using a Java context for persistence.

. The main class to run: +
⇒ link:../../ch04_spring-persistence/src/main/java/eu/mithril/training/spring/framework/ch04/Ex02_DB_JavaConfigured.java[Ex02_DB_JavaConfigured.java] +
...
⇒ link:../../ch04_spring-persistence/src/main/java/eu/mithril/training/spring/framework/ch04/model/DBConfiguration.java[DBConfiguration.java] +
...
. The _Data Access Object_ performs the tasks of operating with the database. The class used for
this example implements the `ColoredShapeDao` interface. +
⇒ link:../../ch04_spring-persistence/src/main/java/eu/mithril/training/spring/framework/ch04/dao/ColoredShapeDaoImplEx02.java[ColoredShapeDaoImplEx02.java] +
This class is an implementation of the `ColoredShapeDao` interface. All CRUD methods are
implemented. The DAO implementation also defines a `RowMapper`, as a `ColoredShapeMapper`, that
