...
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/ColoredShape.java[ColoredShape.java] +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/ColoredShapeHolder.java[ColoredShapeHolder.java]

2. A plain Java example with no spring used +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/Ex00_NoFrameworkExample.java[Ex00_NoFrameworkExample.java].
...
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/xml/Ex01_DIThroughConstructorSimple.java[Ex01_DIThroughConstructorSimple.java]. +
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/xml/Ex02_DIThroughConstructorNamed.java[Ex02_DIThroughConstructorNamed.java] +
This class has a `ClassPathXmlApplicationContext` which reads the XML configuration. The
`ApplicationContext` is the Spring Inversion of Control. The `main` method transfers control of
loading beans to the `ClassPathXmlApplicationContext`, which then loads _beans_ from the XML file.
The XML file provides an injection of a `ColoredShape` _bean_ into a `ColoredShapeHolder` _bean_
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/xml/Ex03_DIThroughConstructorIndex.java[Ex03_DIThroughConstructorIndex.java] +
This class has a `ClassPathXmlApplicationContext` which reads the XML configuration. The
`ApplicationContext` is the Spring Inversion of Control. The `main` method transfers control of
loading beans to the `ClassPathXmlApplicationContext`, which then loads _beans_ from the XML file.
The XML file provides an injection of a `ColoredShape` _bean_ into a `ColoredShapeHolder` _bean_
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/xml/Ex04_DIThroughSetters.java[Ex04_DIThroughSetters.java] +
This class has a `ClassPathXmlApplicationContext` which reads the XML configuration. The
`ApplicationContext` is the Spring Inversion of Control. The `main` method transfers control of
loading beans to the `ClassPathXmlApplicationContext`, which then loads _beans_ from the XML file.
The XML file provides an injection of a `ColoredShape` _bean_ into a `ColoredShapeHolder` _bean_
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/annotation/Ex05_DIThroughAnnotationSetters.java[Ex05_DIThroughAnnotationSetters.java] +
...
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/SetterAnnotatedColoredShapeHolder.java[SetterAnnotatedColoredShapeHolder.java] +
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/annotation/Ex06_DIThroughAnnotationConstructor.java[Ex06_DIThroughAnnotationConstructor.java] +
...
3. The Java Code that injects the dependency +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/ConstructorAnnotatedColoredShapeHolder.java[ConstructorAnnotatedColoredShapeHolder.java] +
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/annotation/Ex07_DIThroughAnnotationWithQualifiers.java[Ex07_DIThroughAnnotationWithQualifiers.java] +
...
3. The Java Code that injects the dependency +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/ConstructorAnnotatedQualifiedColoredShapeHolder.java[ConstructorAnnotatedQualifiedColoredShapeHolder.java] +
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/java/Ex08_DIThroughJava.java[Ex08_DIThroughJava.java] +
This class has an annotation to `@ComponentScan` all Spring-annotated classes in the
`eu.mithril.training.spring.framework.ch02.model` package. This is the Java equivalent of creating bean
...
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/BlackBox.java[BlackBox.java].
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/OrangeOval.java[OrangeOval.java]. +
...
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/AutowiredColoredShapeHolder.java[AutowiredColoredShapeHolder.java] +
...
1. The Java code to execute +
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/java/Ex09_DIThroughJavaConfiguration.java[Ex09_DIThroughJavaConfiguration.java] +
...
⇒ link:../../ch02_spring-dependency-injection/src/main/java/eu/mithril/training/spring/framework/ch02/model/DIConfiguration.java[DIConfiguration.java] +
...
⇒ link:../../ch02_spring-dependency-injection/src/test/java/eu/mithril/training/spring/framework/ch02/xml/Lab01Test.java[xml/Lab01Test.java] +
⇒ link:../../ch02_spring-dependency-injection/src/test/java/eu/mithril/training/spring/framework/ch02/annotation/Lab02Test.java[annotation/Lab02Test.java] +
⇒ link:../../ch02_spring-dependency-injection/src/test/java/eu/mithril/training/spring/framework/ch02/model[model package]
